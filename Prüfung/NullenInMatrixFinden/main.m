...
u_i = u_i_alt + delta_t* ( A_h*u_i_alt + (F_I(infektionsrate_slow,B,w,u_i_alt, u_s_alt,t*delta_t)-w.*u_i_alt));
u_s =  u_s_alt + delta_t*(A_h*u_s_alt+F_S(infektionsrate_slow,B,u_i_alt, u_s_alt,t*delta_t));
 
% F_S=@(ui,us,t) -1*(infektionsrate_slow./B).*ui.*us;  %slowdown in c) berücksichtigen!
